document.getElementById('calcularBoton').addEventListener('click', calculoLetra);
...
function validarFormulario() {
    ...
    if (!/^[0-9]+$/.test(dni) || dni.length < 7 || dni.length > 8) {
        document.getElementById('errorDni').textContent = "Por favor, introduzca un número de DNI válido (entre 7 y 8 dígitos).";
        correcto = false;
    } else {
